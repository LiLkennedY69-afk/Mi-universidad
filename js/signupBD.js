document.addEventListener("DOMContentLoaded", () => {
    ...
    if (signupForm) {
        signupForm.addEventListener("submit", (e) => {
            ...
            // Mapeo de letra a Rol institucional
            if (letraRol === 'a') {
                ...
                Swal.fire({
                    ...
                    text: 'El correo debe terminar en "a", "d" o "e" justo antes del @ (ej. usuarioa@gmail.com)',
                    icon: 'warning'
                });
                return;
            }
            ...
            // Usamos la clave "usuarios_registrados" que ya tienes en uso
            ...
            const newUser = { 
                ...
                email: email, 
                password: password,
                rol: rolAsignado // Aquí se guarda el rol real (Administrador, Docente, Estudiante)
            };
