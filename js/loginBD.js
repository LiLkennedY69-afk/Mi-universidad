document.addEventListener("DOMContentLoaded", () => {
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", (e) => {
            ...
            if (validUser) {
                // --- LÓGICA DE ROLES CORREGIDA: Carácter ANTES del '@' ---
                const posicionArroba = emailInput.indexOf('@');
                // Cambiado de +1 a -1 para coincidir con el registro
                ...
                // 3. Guardar en sesión el usuario activo
