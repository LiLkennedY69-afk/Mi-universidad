document.addEventListener("DOMContentLoaded", () => {
    ...
    const renderizarCursos = () => {
        ...
        misCursos.forEach((curso) => {
            // BUSQUEDA SEGURA: Buscamos el índice real comparando clave Y dueño
    ...
    btnAgregar.addEventListener("click", async () => {
        ...
        if (formValues) {
            ...
            // VALIDACIÓN: Evitar que el MISMO docente use la misma clave dos veces
            ...
            const nuevoCurso = {
                ...
                docenteId: activeUser.username, // ID del dueño logueado
                estudiantes: [], 
                tareas: [], 
                materiales: [] 
            };
    ...
    contenedor.addEventListener("click", (e) => {
        ...
        if (e.target.classList.contains("btn-eliminar")) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Doble verificación: Asegurar que el curso en ese índice realmente le pertenece
        ...
        if (e.target.classList.contains("btn-editar")) {
            let cursosGlobales = JSON.parse(localStorage.getItem("cursos_docente"));
            // Verificar pertenencia antes de permitir editar
            if (cursosGlobales[index].docenteId === activeUser.username) {
